...
export default function Index(): JSX.Element {
  ...
  const currentPlayMusic: {thumb : string, title: string, singer: string, lyrics: string} = {
    thumb: "/album_thumb_01.jpg",
    title: "MAGIC!",
    singer: "Zior Park",
    lyrics:
  ...
  return (
    <div className="player">
      <PlayerList player={player} openPlaylist={openPlaylist} musicListData={musicListData} currentPlayMusic={currentPlayMusic} />
